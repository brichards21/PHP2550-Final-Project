...
#write.amelia(imputed_dat, file.stem = "data/imputed_tetra_test_df.csv")


#imp_data <- cbind(imputed_dat$imputations[[1]],
 #         tetra_test[, 11:ncol(tetra_test)])

#write_csv(imp_data, #"data/imputed_tetra_test_df.csv")
