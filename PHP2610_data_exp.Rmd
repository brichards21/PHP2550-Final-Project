...
Next, we look at the locations represented in our data. We'll reduce the location variable in our data to just be the countries 

```{r}

table(isolates_df$location)
